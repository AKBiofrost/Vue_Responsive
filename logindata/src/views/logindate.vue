...
<v-card
    class="mx-auto pa-2 mb-2 rounded-xl "
    max-width="400"
    min-width="100"
 ...
 >
   <v-hover 
    ...
    align="center"
      ...
      max-width="130"
      min-height="130"
     @click="$vuetify.goTo($refs.positividad_por_pais)" 
      >
...
<h5 >  Positividad por Países   </h5 >

    </v-card>
</v-hover>
  </div>
<!--------- positividad por etiqueta------------->
 <div class="text-center mb-2 pa-2 ">
   ...
   <v-hover 
     v-slot="{ hover }"
       >
    <v-card
    class=" justify-center  pa-2 mb-5  "
    align="center"
    :elevation="hover ? 12 : 2"
      color="#fff"
    max-width="130"
      min-height="130"
     @click="$vuetify.goTo($refs.positividad_por_etiqueta)" 
      >
 ...
 src="https://report.cool-shockley.142-44-201-186.plesk.page/images/VUE_marcador.svg"
   ...
   <h5 >   Positividad por Etiqueta</h5 > 
    </v-card>
    </v-hover>
  </div>
<!--------- Tablero------------->
...
<div class="text-center mb-2 pa-2 ">
    ...
    align="center"
     ...
     @click="$vuetify.goTo($refs.positividad_por_pais)" 
      ...
      width="55%" 
      justify="center"
 src="https://report.cool-shockley.142-44-201-186.plesk.page/images/VUE_seo.png"
      ></v-img>

   <h5>  Posicionamiento SERP </h5>
    </v-card>
  </div>
 ...
 <div class="text-center mb-2 pa-2 ">
    ...
    align="center"
     ...
     @click="$vuetify.goTo($refs.positividad_por_pais)" 
      ...
      width="55%" 
      justify="center"
 src="https://report.cool-shockley.142-44-201-186.plesk.page/images/VUE_publicidad.png"
      ></v-img>
<h5> Detractores en web </h5>
...
<v-card
      flat
      max-width="8%"
      class="  d-flex flex-row  justify-space-between white--text "
      @click="atras"
    >
      <v-img 
      width="15%" 
 ...
 src="https://report.cool-shockley.142-44-201-186.plesk.page/images/atras.svg"
    ...
    <v-card
      flat
      max-width="8%"
      class="  d-flex flex-row-reverse justify-space-between  white--text"
      @click=" adelante "
    >
      <v-img 
      width="15%" 
...
<!-- posicionamiento web--> 
    <v-card 
     class="d-flex justify-center  pa-5 mb-5"
  elevation="10"
...
<!-- Paises dinamico-->
<div 
   v-if="promedioWeb[n][m]>-1"
  > 
  {{paisWeb[m]}}  

<!-- Promedio dinamico-->
<h4>  {{promedioWeb[n][m]}} % </h4>
<!-- cuadros de colores dinamico-->


<v-col>
<div
        v-for="(color, indice) in colores[n][m]"
          :key="color.name" 
        >
<v-row    
           v-if="indice <20"
...
<!--  fincuadros de colores dinamico-->
...
<v-card class=" d-flex justify-center teal lighten-4">
...
<h3>URL+ Positivos </h3 >
   ...
   <v-card class=" d-flex justify-center cyan darken-1 ">

<h3>URL+ Posicionamiento MDQ </h3 >

 </v-card>

 <v-card class=" d-flex justify-center teal darken-2 ">

<h3>URL+ Posicionamiento Aliados </h3 >
...
<v-card class=" d-flex justify-center red lighten-1">
<h3>URL-contratados </h3 >

 </v-card>

<v-card class="d-flex justify-center  red darken-4">
<h3>URL-posteriores </h3 >
...
<div >
<h3>
  URL + Posicionado MQD: Son resultados de contenido
positivo posicionados en medios influenciados por
</h3 >
...
//-----REDISEÑO-----
  ...
  //this.graficaPais_pais.push(" ")
    //  this.graficaPais_etiqueta.push(" ")
...
for(var i=0; i<datos.data[0].length;i++){
